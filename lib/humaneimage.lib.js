  ...
  "renderViewAsBase64": function (currentView, options) {
    ...
    let cfg = {
      ...
      rgbColorByElementType         : {
        "application-collaboration" : "#ccfdfe",
        "application-component"     : "#ccfdfe",
        "application-event"         : "#ccfdfe",
        "application-function"      : "#ccfdfe",
        "application-interaction"   : "#ccfdfe",
        "application-interface"     : "#ccfdfe",
        "application-process"       : "#ccfdfe",
        "application-service"       : "#ccfdfe",
        "artifact"                  : "#cae6b9",
        "assessment"                : "#cccdfd",
        "business-actor"            : "#fffeb9",
        "business-collaboration"    : "#fffeb9",
        "business-event"            : "#fffeb9",
        "business-function"         : "#fffeb9",
        "business-interaction"      : "#fffeb9",
        "business-interface"        : "#fffeb9",
        "business-object"           : "#fffeb9",
        "business-process"          : "#fffeb9",
        "business-role"             : "#fffeb9",
        "business-service"          : "#fffeb9",
        "communication-network"     : "#cae6b9",
        "capability"                : "#eddfac",
        "constraint"                : "#cccdfd",
        "contract"                  : "#fffeb9",
        "course-of-action"          : "#eddfac",
        "data-object"               : "#ccfdfe",
        "deliverable"               : "#fee0e0",
        "device"                    : "#cae6b9",
        "junction"                  : "#000000",
        "diagram-model-group"       : "#d2d7d7",
        "distribution-network"      : "#cae6b9",
        "driver"                    : "#cccdfd",
        "equipment"                 : "#cae6b9",
        "facility"                  : "#cae6b9",
        "gap"                       : "#e0ffe0",
        ...
        "principle"                 : "#cccdfd",
        "product"                   : "#fffeb9",
        "representation"            : "#fffeb9",
        "resource"                  : "#eddfac",
        "requirement"               : "#cccdfd",
        "stakeholder"               : "#cccdfd",
        "system-software"           : "#cae6b9",
        "technology-collaboration"  : "#cae6b9",
        "technology-event"          : "#cae6b9",
        "technology-function"       : "#cae6b9",
        "technology-interaction"    : "#cae6b9",
        "technology-interface"      : "#cae6b9",
        "technology-process"        : "#cae6b9",
        "technology-service"        : "#cae6b9",
        "value"                     : "#cccdfd",
        "value-stream"              : "#eddfac",
        "work-package"              : "#fee0e0"
      },
    ...
    function _renderViewAsSvgBase64(currentView, cfg) {
      ...
      function _drawMultilineText (text, x, y, widthLimit, heightLimit, fontName, fontSize, fontWeight, fontStyle, textAlignment, textPosition, doNotDrawTextIfBoxIsTooSmall, layoutGapTolerance) {
        ...
        for (let newTextLine of newText) {
          ...
          textData = textData + `<tspan x="${horizontalTextPosition + 1}" y="${dy}" font-weight="${fontWeight}" font-style="${fontStyle}">${newTextLine}</tspan>`
          dy+= (lineHeight )
        }
      ...
      function _drawElement (bounds, element, level, cfg) {
        ...
        if (element.type =="business-actor" || element.type == "business-role" || element.type == 'stakeholder') {
          if (cfg.drawUserIconsEnabled == true) {
            ...
            let iconColor      = _invertColor(fillColor)
      ...
      function _bestCoordinates (sourceBounds, targetBounds, cfg) {
        ...
        let centerPointOnSource  = { x: (sourceBounds.x + (sourceBounds.width  / 2)), y: (sourceBounds.y + (sourceBounds.height / 2)) }
        let centerPointOnTarget  = { x: (targetBounds.x + (targetBounds.width  / 2)), y: (targetBounds.y + (targetBounds.height / 2)) }
      ...
      function _drawEdges (currentView, cfg) {
        ...
        connections.each (function (e) {
          ...
          if (relText.trim().length != 0) {
            ...
            let invertedFontColor = _invertColor(fontColor)
            let lineText = `<text x="${relTextPoint.x}" y="${relTextPoint.y}" font-size="${actualFontSize}" font-weight="${fontWeight}" font-style="${fontStyle}" stroke-width="3" stroke="${invertedFontColor}" text-anchor="middle"  fill="${invertedFontColor}">${textData}</text>`
